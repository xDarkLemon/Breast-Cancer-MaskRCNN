...
#         print(dataset_dir) # May15
        image_ids = next(os.walk(dataset_dir))[1]
#         print(image_ids) # May15
        ...
        for image_id in image_ids:
            self.add_image(
                "mass",
                image_id=image_id,
                path=os.path.join(dataset_dir, image_id, "full_image/{}.png".format(image_id))) # png
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        mask = []
#         print(mask_dir) # May15
        for f in next(os.walk(mask_dir))[2]:
            if f.endswith(".png"): # May15
...
#         print("Mask shape before np.stack:", mask) # May15
        mask = np.stack(mask, axis=-1)
#         print("Mask shape after np.stack:", mask.shape) # May15
